...
* Detects new games automatically and skips duplicates
* **Intelligent executable detection** — prioritizes name-matched launchers over shipping/UE4 binaries, minimum 500 KB threshold, extensive skip list for crash reporters and tools
* **Cover art**: Steam CDN (portrait), GOG API, Steam SearchApps fallback for Epic/GOG, EXE icon extraction as a last resort
